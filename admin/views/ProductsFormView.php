...
<div class="col-md-12">  
    <div class="panel panel-primary">
        ...
        <form method="post" enctype="multipart/form-data" action="<?php echo $action; ?>">
            ...
            <!-- end rows -->
            <div class="row" style="margin-top:5px;">
                <div class="col-md-2">Votage</div>
                <div class="col-md-10">
                    <input type="text" value="<?php echo isset($record->votage)?$record->votage:'0'; ?>" name="votage" required style="width: 150px;"> %
                </div>
            </div>
            <!-- rows -->
            <div class="row" style="margin-top:5px;">
                ...
                <div class="col-md-10">
                    <input type="text" value="<?php echo isset($record->price)?$record->price:'0'; ?>" name="price" required style="width: 150px;"> VNĐ
                </div>
            </div>
            <!-- end rows -->
            <!-- rows -->
            ...
            <div class="row" style="margin-top:5px;">
                ...
                <div class="col-md-10">
                    <input type="text" value="<?php echo isset($record->hot)?$record->hot:'0'; ?>" name="hot" id="hot">
                </div>
            </div>
            <!-- end rows -->
            <!-- rows -->
