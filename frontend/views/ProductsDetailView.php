                           ...
                           <!-- Product Details Left -->
                            <div class="product-details-left">
                                <div class="product-details-images slider-navigation-1">
                                    <div class="lg-image">
                                        <a class="popup-img venobox vbox-item" href="images/product/large-size/products/1.jpg" data-gall="myGallery">
                                            <img src="../assets/upload/products/<?php echo $record->photo; ?>" alt="product image">
                                        </a>
                                    </div>
                                    <div class="lg-image">
                                        <a class="popup-img venobox vbox-item" href="images/product/large-size/products/1.jpg" data-gall="myGallery">
                                ...
                                <div class="product-info">
                                    ...
                                    <div class="rating-box pt-20">
                                        <ul class="rating rating-with-review-item">
                                            ...
                                            <li class="no-star"><i class="fa fa-star-o"></i></li>
                                            <li class="review-item"><a href="#" data-toggle="modal" data-target="#mymodal1">Xem đánh giá</a></li>
                                            <li class="review-item"><a href="#" data-toggle="modal" data-target="#mymodal">Viết đánh giá</a></li>
                                            <div class="modal fade modal-wrapper" id="mymodal1" >
                                        <div class="modal-dialog modal-dialog-centered" role="document">
                                            <div class="modal-content">
                                                <div class="modal-body">
                                                    <h3 class="review-page-title">Xem đánh giá</h3>
                                                    <div class="modal-inner-area row">
                                                        <div class="col-lg-6">
                                                           <div class="li-review-product">
                                                               <img src="images/product/large-size/products/1.jpg" style="width: 400px; height:400px;" alt="Li's Product">
                                                               <div class="li-review-product-desc">
                                                                   <p class="li-product-name">Máy vặn vít</p>
                                                                   <p>
                                                                       <span>Máy Vặn Vít Dùng Pin TD001GM201 được sản xuất trên dây chuyền lắp ráp thiết bị cao cấp hiện đại, thiết kế đẹp. Tay cầm chắc chắn vừa vặn, có bọc đệm cao su mềm tiện lơi, chống trơn trượt, giúp vận hành thoải mái, kiểm soát máy dễ dàng hơn, và giảm mỏi tay trong quá trình sử dụng. </span>
                                                                   </p>
                                                               </div>
                                                           </div>
                                                        </div>
                                                        <div class="col-lg-6">
                                                            <div class="li-review-content">
                                                                ...
                                                                <div class="feedback-area">
                                                                    <div class="feedback">
                                                                        <h3 class="feedback-title">Đánh giá nhận được</h3>
                                                                        <form action="#">
                                                                ...
                                                                <li class="no-star"><i class="fa fa-star-o"></i></li>
                                                                            ...
                                                                            <!-- <div class="feedback-input">
                                                                                ...
                                                                                <p class="feedback-form-author feedback-form-email">
                                                                                    ...
                                                                                    <span class="required"><sub>*</sub> Bắt buộc</span> -->
                                                                                </p>
                                    ...
                                    <div class="price-box pt-20">
                                        <span class="new-price new-price-2"><?php echo $record->price; ?></span>
                                    </div>
                                    <div class="product-desc">
                                        <p>
                                            <span>Công suất mạnh mẽ, vận hành êm ái bền bỉ, động cơ không chổi than.
                                            </span>
                                        </p>
                                    </div>
                        ...
                        <div id="reviews" class="tab-pane" role="tabpanel">
                            <div class="product-reviews">
                                <div class="product-details-comment-block">
                                    ...
                                    <div class="rereview-btn">
                                    <div class="review-btn">
                                        <a class="review-links" href="#" data-toggle="modal" data-target="#mymodal1">Xem đánh giá!</a>
                                    </div>
                                    <div class="review-btn">
                                            ...
                                            <div class="modal-content">
                                                <div class="modal-body">
                                                    ...
                                                    <div class="modal-inner-area row">
                                                        <div class="col-lg-6">
                                                           <div class="li-review-product">
                                                               <img src="images/product/large-size/products/1.jpg" alt="Li's Product">
                                                               <div class="li-review-product-desc">
                                                                   <p class="li-product-name">Máy vặn vít</p>
                                                                   <p>
                                                                       <span>Máy Vặn Vít Dùng Pin TD001GM201 được sản xuất trên dây chuyền lắp ráp thiết bị cao cấp hiện đại, thiết kế đẹp. Tay cầm chắc chắn vừa vặn, có bọc đệm cao su mềm tiện lơi, chống trơn trượt, giúp vận hành thoải mái, kiểm soát máy dễ dàng hơn, và giảm mỏi tay trong quá trình sử dụng. </span>
                                        ...
                                        <div class="single-product-wrap">
                                            ...
                                            <div class="product_desc">
                                                <div class="product_desc_info">
                                                    ...
                                                    <h4><a class="product_name" href="single-product.html">Khoan bắt vít</a></h4>
                                                    <div class="price-box">
                                        ...
                                        <div class="single-product-wrap">
                                            ...
                                            <div class="product_desc">
                                                <div class="product_desc_info">
                                                    ...
                                                    <div class="price-box">
                                                        <span class="new-price">2.999.000đ</span>
                                                    </div>
                                                </div>
                                                <div class="add-actions">
                                                    <ul class="add-actions-link">
                                        ...
                                        <div class="single-product-wrap">
                                            ...
                                            <div class="product_desc">
                                                <div class="product_desc_info">
                                                    ...
                                                    <h4><a class="product_name" href="single-product.html">Máy cưa gỗ</a></h4>
                                                    <div class="price-box">
